...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'suricata_suricata', 'ruleset_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rules.Ruleset'], null=True))

    def backwards(self, orm):

        # Changing field 'Suricata.ruleset'
        db.alter_column(u'suricata_suricata', 'ruleset_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['rules.Ruleset']))
    ...
    models = {
        ...
        u'suricata.suricata': {
            ...
            'ruleset': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rules.Ruleset']", 'null': 'True', 'blank': 'True'}),
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'})
        }
    }

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Suricata'
        db.create_table(u'suricata_suricata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('descr', self.gf('django.db.models.fields.CharField')(max_length=400)),
            ...
            ('ruleset', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rules.Ruleset'], blank=True)),
        ))
        db.send_create_signal(u'suricata', ['Suricata'])


    def backwards(self, orm):
        # Deleting model 'Suricata'
        db.delete_table(u'suricata_suricata')

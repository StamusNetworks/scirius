    ...
    return (
      <Menu
        ...
        onOpenChange={(openKeys) => {
          if (openKeys.length) this.fetchData(data.flow_id);
          else this.setState({ showTabs: false });
        }}
      >
        <Menu.SubMenu
          key="1"
          icon={<BellOutlined className={iconclass} style={{ fontSize: '27px' }} />}
          title={
        ...
        >
          <Menu.Item key="2" style={{ height: '100%' }}>
            <Tabs id="alert-tabs">

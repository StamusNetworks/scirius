...
const makeSelectFilterOptions = (queryTypes) => createSelector(selectRules, subState => subState.filterList.filter(f => (queryTypes.indexOf(f.queryType) !== -1 && f.filterType !== 'hunt')));

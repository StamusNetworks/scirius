...
urlpatterns = patterns('',
    ...
    url(r'^rule/(?P<rule_id>\d+)/drop/(?P<ruleset_id>\d+)$', views.toggle_drop, name='toggle_drop'),
    url(r'^rule/(?P<rule_id>\d+)/filestore/(?P<ruleset_id>\d+)$', views.toggle_filestore, name='toggle_filestore'),
    url(r'^rule/(?P<rule_id>\d+)/transform$', views.transform_rule, name='transform_rule'),

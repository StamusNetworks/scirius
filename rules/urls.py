...
urlpatterns = [
    ...
    re_path(r'^ruleset/(?P<ruleset_id>\d+)/export/$', views.ruleset_export, name='export_ruleset'),
    ...
    re_path(r'^rule_at_version/(?P<rav_id>\d+)/availability/$', views.rav_toggle_availability, name='rav_toggle_availability'),
    re_path(r'^rule/(?P<rule_id>\d+)/availability/$', views.rule_toggle_availability, name='rule_toggle_availability'),
    ...
    re_path(r'^rule/pk/(?P<rule_id>\d+)/$', views.rule, name='rule'),
    re_path(r'^rule/(?P<rule_id>\d+)/$', views.rule, name='rule_sid'),
    re_path(r'^rule/pk/(?P<rule_id>\d+)/test/(?P<ruleset_id>\d+)/$', views.test_rule, name='test_rule'),
    ...
    re_path(r'^stasks$', views.stasks, name='view_stasks'),

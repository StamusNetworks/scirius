...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ruleset.need_test'
        db.add_column(u'rules_ruleset', 'need_test',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Ruleset.validity'
        db.add_column(u'rules_ruleset', 'validity',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ruleset.need_test'
        db.delete_column(u'rules_ruleset', 'need_test')

        # Deleting field 'Ruleset.validity'
        db.delete_column(u'rules_ruleset', 'validity')

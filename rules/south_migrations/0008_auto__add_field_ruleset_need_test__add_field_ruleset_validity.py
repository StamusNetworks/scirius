...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('rules_ruleset', 'need_test',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Ruleset.validity'
        db.add_column('rules_ruleset', 'validity',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('rules_ruleset', 'need_test')

        # Deleting field 'Ruleset.validity'
        db.delete_column('rules_ruleset', 'validity')

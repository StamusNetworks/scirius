...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('rules_reference', 'value', self.gf('django.db.models.fields.CharField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'Reference.value'
        db.alter_column('rules_reference', 'value', self.gf('django.db.models.fields.CharField')(max_length=100))

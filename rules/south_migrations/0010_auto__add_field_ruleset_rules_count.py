...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ruleset.rules_count'
        db.add_column(u'rules_ruleset', 'rules_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ruleset.rules_count'
        db.delete_column(u'rules_ruleset', 'rules_count')

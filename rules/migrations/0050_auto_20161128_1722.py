    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(max_length=12, choices=[(b'disable', b'Disable'), (b'enable', b'Enable'), (b'comment', b'Comment'), (b'activate', b'Activate'), (b'deactivate', b'Deactivate'), (b'drop', b'Drop'), (b'reject', b'Reject'), (b'filestore', b'Filestore'), (b'create', b'Create'), (b'delete', b'Delete'), (b'modify', b'Modify')])),

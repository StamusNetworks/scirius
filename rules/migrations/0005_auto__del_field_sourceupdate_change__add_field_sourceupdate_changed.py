...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'rules_sourceupdate', 'change')

        # Adding field 'SourceUpdate.changed'
        db.add_column(u'rules_sourceupdate', 'changed',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'rules_sourceupdate', 'change',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'SourceUpdate.changed'
        db.delete_column(u'rules_sourceupdate', 'changed')

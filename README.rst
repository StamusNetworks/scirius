...
create and edit users for scirius. ``syncdb`` should have created one for you. If it is not the case, you
can run from the Scirius base directory(/opt/selks/scirius/) ::

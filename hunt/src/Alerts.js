...
class AlertInList extends React.Component {
    ...
    render() {
        ...
        var ip_params = <div> {data.src_ip} <span className="glyphicon glyphicon-arrow-right"></span> {data.dest_ip}
        </div>;
